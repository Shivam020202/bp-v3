...
const MegaMenuHeader = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 container mx-auto ${isScrolled || isContactPage
...
>>>>>>> Stashed changes
      ...
      <div
        className={`lg:hidden fixed inset-0 z-[99999] transition-all duration-500 ${isMobileMenuOpen
