...
const bannerImage = "https://res.cloudinary.com/damfndmrm/image/upload/v1770805062/Untitled_design_3_thi5vs.png";

const SocialMediaBannerHero = () => {
    return (
        <section className="relative w-full h-screen overflow-hidden flex items-center">
            ...
            <div className="container mx-auto px-6 relative z-10 pt-24 md:pt-32">
                <div className="max-w-3xl">
                    ...
                    >
                        Build community and engagement across all major platforms with strategic content and community management.
                    </motion.p>
...
export default SocialMediaBannerHero;
