...
const WhyChooseUs = () => {
  ...
  return (
    <section className="pb-10 bg-white text-black overflow-hidden border-t border-black/5">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
            ...
            {principles.map((item) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="overflow-hidden pl-[3rem]"
                >
                  <p className="text-gray-500 pt-3 text-sm md:text-base leading-relaxed max-w-2xl">
                    {item.description}
                  </p>
                </motion.div>
              </div>
          ...
          <div className="hidden lg:flex w-full lg:w-5/12 relative h-[450px] items-center justify-center  rounded-2xl overflow-hidden">
            {/* Main Graphic - Image */}
