...
const services = [
    {
        ...
        description: "Rank higher on Google with data-driven SEO strategies tailored for businesses in Gurugram and NCR.",
        icon: <Search />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817880/SEO_qymlqf.svg",
        link: "/services/seo-optimization",
    },
    {
        id: "02",
        title: "Paid Advertising",
        description: "Maximize ROI with precision-targeted PPC campaigns for the Gurugram market.",
        icon: <Megaphone />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817877/Digital_Promotion_q5zfml.svg",
        link: "/services/paid-advertising",
    },
    {
        id: "03",
        title: "Social Media",
        description: "Build a powerful social presence that resonates with Gurugram's digital-savvy audience.",
        icon: <Share2 />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817876/Social_Media_Activity_qmsix9.svg",
        link: "/services/social-media",
    },
    {
        id: "04",
        title: "Content Marketing",
        description: "Compelling storytelling that positions your Gurugram business as an industry authority.",
        icon: <PenTool />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817877/Creative_Content_Writer_nrybwy.svg",
        link: "/services/content-marketing",
    },
    {
        id: "05",
        title: "Email Marketing",
        description: "Personalized email automation flows that nurture and convert local leads.",
        icon: <Mail />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817876/Chat_Via_Email_nwa7vz.svg",
        link: "/services/email-marketing",
    },
    {
        id: "06",
        title: "AI & Automation",
        description: "Leverage cutting-edge AI tools to automate marketing for Gurugram businesses.",
        icon: <BarChart />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817876/AI_and_Data_Integration_o0cqqm.svg",
        link: "/services/ai-automation",
    },
    {
        id: "07",
        title: "Youtube Marketing",
        description: "Increase visibility and engagement with video content for NCR audiences.",
        icon: <TrendingUp />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817876/Video_Learning_nojkh4.svg",
        link: "/services/youtube-marketing",
    },
    {
        id: "08",
        title: "Web Development",
        description: "Develop responsive, high-performance websites for Gurugram enterprises.",
        icon: <Zap />,
        image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1768817880/App_Development_jawnsm.svg",
        link: "/services/web-development",
    },
];

const stats = [
    { number: "200+", label: "Gurugram Clients", icon: <Building2 className="w-5 h-5" /> },
    { number: "₹50Cr+", label: "Ad Spend Managed", icon: <BarChart className="w-5 h-5" /> },
    { number: "1M+", label: "Leads Generated", icon: <Users className="w-5 h-5" /> },
    { number: "15+", label: "Startups Scaled to Unicorns", icon: <Rocket className="w-5 h-5" /> },
];
...
const whyChooseData = [
    {
        ...
        description: "We don't just know Gurugram; we live it. From Cyber Hub trends to Sector 29 buzz, our strategies are locally relevant.",
    },
    {
        icon: <Trophy className="w-6 h-6" />,
        title: "Award-Winning Strategy",
        description: "Recognized by top industry bodies for delivering campaigns that don't just look good, but perform exceptionally.",
    },
    {
        icon: <Globe className="w-6 h-6" />,
        title: "Global Standards, Local Touch",
        description: "Bringing international design and tech standards to Gurugram businesses, ensuring you stand out globally.",
    },
    {
        icon: <Target className="w-6 h-6" />,
        title: "Revenue-Focused",
        description: "We move the needle where it matters. Our campaigns are optimized for conversions, sales, and tangible growth.",
    },
    {
        icon: <Monitor className="w-6 h-6" />,
        title: "Full-Stack Tech",
        description: "In-house developers and AI specialists ensuring your marketing is backed by robust, cutting-edge technology.",
    },
    {
        icon: <Smartphone className="w-6 h-6" />,
        title: "Mobile-First Approach",
        description: "With 80% of local traffic on mobile, we ensure your brand looks and works perfectly on every device.",
    },
];
...
const faqs = [
    {
        ...
        answer: "Our Gurugram office is located in Sector 32, at the SupremeWork Co-working Space. We're easily accessible via major roads and the metro.",
    },
    {
        question: "What digital marketing services do you offer in Gurugram?",
        answer: "We offer a full suite of digital marketing services including SEO, Paid Advertising (Google & Meta Ads), Social Media Marketing, Content Marketing, Email Marketing, YouTube Marketing, Web Development, and AI-powered automation solutions.",
    },
    {
        question: "How is Branding Pioneers different from other agencies in Gurugram?",
        answer: "We combine data-driven strategies with creative excellence. With 8+ years of experience, 200+ Gurugram clients, and a 98% retention rate, we deliver measurable results. Our local market expertise and dedicated account teams ensure personalized attention.",
    },
    {
        question: "Do you work with startups as well as enterprises in Gurugram?",
        answer: "Absolutely! We partner with ambitious brands of all sizes - from early-stage startups in coworking spaces to established enterprises in Cyber Hub. Our strategies are tailored to your stage and budget.",
    },
    {
        question: "Can I visit your Gurugram office for a consultation?",
        answer: "Yes, we welcome in-person consultations at our Gurugram office. You can book a free strategy session through our website or call us directly. We also offer virtual consultations for your convenience.",
    },
    {
        question: "What industries do you serve in Gurugram?",
        answer: "We serve a wide range of industries including Real Estate, Healthcare, Fintech, E-commerce, Education, Hospitality, FMCG, and Technology. Our diverse portfolio ensures we understand the unique challenges of each sector.",
    },
];

const clientLogosRow1 = [
    { name: "Max Home", logo: "https://res.cloudinary.com/damfndmrm/image/upload/v1769580795/max_home-logo_ya130a.png", featured: true },
    ...
    { name: "LCH Africa", logo: "https://lchafrica.com/img/cropped-FINAL-LOGO-svg.png", featured: true },
...
const clientLogosRow2 = [
    ...
    { name: "DST", logo: "https://res.cloudinary.com/damfndmrm/image/upload/v1769580794/dst_k894jm.webp", featured: true },
...
const certifications = [
    { name: "Google Partner", logo: "https://www.vectorlogo.zone/logos/google/google-ar21.svg" },
    { name: "Meta Business Partner", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Meta_Platforms_Inc._logo.svg/800px-Meta_Platforms_Inc._logo.svg.png" },
    { name: "HubSpot Certified", logo: "https://www.vectorlogo.zone/logos/hubspot/hubspot-ar21.svg" },
    { name: "Shopify Partner", logo: "https://www.vectorlogo.zone/logos/shopify/shopify-ar21.svg" },
];
...
const GurgaonLocationPage = () => {
    ...
    const marqueeRow1 = [...clientLogosRow1, ...clientLogosRow1, ...clientLogosRow1, ...clientLogosRow1];
    const marqueeRow2 = [...clientLogosRow2, ...clientLogosRow2, ...clientLogosRow2, ...clientLogosRow2];
      ...
      ════════════════════════════════════════════════════════════════════════ */}
            <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center z-10 overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center text-white relative z-10">
                    ...
                    >
                        DIGITAL <span className="text-stroke-white text-transparent">DOMINANCE</span> <br className="hidden sm:block" />
                    ...
                    >
                        We are the premier digital growth partner for Gurugram's most ambitious brands.
                        From Cyber City to Golf Course Road, we turn local businesses into market leaders.
                    </motion.p>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <span className="relative z-10 uppercase tracking-wider font-bold text-xs">Bootstrap Your Growth</span>
                ...
                <div className="container mx-auto">
                    ...
                    >
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
                            <span className="text-xs font-mono uppercase tracking-widest text-gray-400">Certified Excellence</span>
                            <div className="flex items-center gap-8 md:gap-12 flex-wrap justify-center hover:grayscale-0 transition-all duration-500">
                                {certifications.map((cert, idx) => (
                                    <img key={idx} src={cert.logo} alt={cert.name} className="h-6 md:h-8 w-auto object-contain" />
                                ))}
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-6xl font-black tracking-tighter leading-[0.95] mb-8">
                                LOCALLY ROOTED, <br />
                                <span className="italic font-serif text-gray-400">GLOBALLY RESPECTED.</span>
                            </h2>

                            <p className="text-lg text-gray-600 leading-relaxed mb-8">
                                Located in the heart of Sector 32, our Gurugram office is more than just a workspace—it's an innovation lab.
                                We understand the unique pulse of the NCR market, from the corporate corridors of Cyber City to the
                                bustling retail hubs of Ambience Mall.
                            </p>
                        ...
                        <div className="relative">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    <div className="rounded-2xl overflow-hidden h-64 w-full">
                                        <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" alt="Office 1" />
                                    </div>
                                    <div className="rounded-2xl overflow-hidden h-40 w-full">
                                        <img src="https://images.unsplash.com/photo-1604328698692-f76ea9498e76?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" alt="Office 2" />
                                    </div>
                                </motion.div>
                                <motion.div
                                ...
                                >
                                    <div className="rounded-2xl overflow-hidden h-40 w-full">
                                        <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" alt="Office 3" />
                                    </div>
                                    <div className="rounded-2xl overflow-hidden h-64 w-full">
                                        <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" alt="Office 4" />
                                    </div>
                                </motion.div>
                            </div>
                            ...
                            >
                                <div className="text-center">
                                    <span className="block text-3xl font-black text-[#C4A484]">4.9</span>
                                    <div className="flex gap-0.5 my-1">
                                        {[1, 2, 3, 4, 5].map(s => <Star key={s} className="w-3 h-3 text-yellow-400 fill-yellow-400" />)}
                                    </div>
                                    <span className="text-[10px] uppercase font-bold text-gray-400">Google Rating</span>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                            ...
                            <Link to={service.link} key={service.id}>
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-6">
                                        <h3 className="text-xl font-bold mb-2 text-white group-hover:text-[#C4A484] transition-colors">{service.title}</h3>
                                        ...
                                        <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#C4A484] opacity-80 group-hover:opacity-100 transform translate-y-0 transition-all">
                                            Explore Service <ArrowUpRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                                        </div>
                                    </div>
                                </motion.div>
                            </Link>
                ...
                <div className="container mx-auto px-6">
                    <motion.div className="text-center mb-16">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 text-black">
                            ...
                            <span className="text-[#C4A484] italic font-serif">CHOOSE US.</span>
                        </h2>
                    </motion.div>
                        ...
                        {whyChooseData.map((item, idx) => (
                            ...
                            >
                                <div className="z-10 relative h-full flex flex-col justify-between">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[#C4A484] transition-colors">{item.title}</h3>
      ...
      ════════════════════════════════════════════════════════════════════════ */}
            <section className="py-16 bg-white overflow-hidden border-t border-gray-100">
                <div className="container mx-auto px-6 mb-10 text-center">
                    <span className="text-xs font-mono uppercase tracking-widest text-gray-400">Trusted By 200+ Companies</span>
                </div>
                <div className="flex w-full overflow-hidden">
                    ...
                    >
                        {[...marqueeRow1, ...marqueeRow2].map((client, i) => (
                            <img key={i} src={client.logo} alt={client.name} className="h-8 md:h-12 w-auto object-contain hover:scale-110 transition-transform" />
                        ))}
                        {[...marqueeRow1, ...marqueeRow2].map((client, i) => (
                            <img key={`dup-${i}`} src={client.logo} alt={client.name} className="h-8 md:h-12 w-auto object-contain hover:scale-110 transition-transform" />
                        ))}
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl md:text-5xl font-black mb-6">
                                READY TO <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C4A484] to-[#f0d5ba]">GROW?</span>
                            </h2>
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                                    ...
                                    <p className="text-gray-400 text-sm">+91 9811780937</p>
                                </div>
                                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                                    <Mail className="w-6 h-6 text-[#C4A484] mb-4" />
                                    <h4 className="font-bold text-lg mb-1">Email Us</h4>
                                    <p className="text-gray-400 text-sm">official@brandingpioneers.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3 text-gray-400 text-sm">
                                ...
                                <span>Ground Floor, SupremeWork Co-working Space, Plot No. 84, Institutional Area, Sector 32, Gurugram, Haryana 122001</span>
                            </div>
                        </div>
            ...
            <section className="py-16 md:py-24 bg-white relative">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-500">Common questions about our Gurugram operations.</p>
                    </div>
